        ...
        <div class="BO_chapter_container">
            ...
            <div class="BO_chapter">
                ...
                <h3>
                    ...
                    <p><?= nl2br(implode(' ', $contentPreview)) . '... ' ?> <em><a class="all_chapter" href="index.php?action=BO_post&amp;id=<?= $data['id'] ?>">Voir le chapitre entier</a></em>
                    </p>
                    
                    <p><em><a class="modifPost" href="index.php?action=BO_updatePost&amp;id=<?= $data['id'] ?>">[Modifier le Chapitre]</a></em>
